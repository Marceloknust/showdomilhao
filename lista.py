...
listaJogadores = ['Carlos', 'André', 'Matias', 'Lucas', 'José', 'Ronaldo', 'O própio Silvio Santos']

listaPontuacao = [3, 4, 9, 5, 6, 7, 15]

listaPergunta = ["""Normalmente, quantos litros de sangue uma pessoa tem? Em média, quantos são retirados numa doação de sangue?
...
"""O que são Acordo de Paris e Tríplice Aliança respectivamente?
